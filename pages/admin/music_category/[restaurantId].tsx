...
export async function getServerSideProps(context) {
  ...
  return { props: { MusicList: result, restaurantId: context.params.restaurantId } };
}
    ...
    <>
      <div className="flex flex-wrap">
        <div className="w-full h-screen">
          <CardListMusicCategory list={props.MusicList} restaurantId={props.restaurantId} />
        </div>
      </div>
    </>
  );
