  ...
  let responseBooking = await prisma.bOOKING.findMany({
    where: {
      ...
      BOOK_DATETIME: { 
        ...
        gte: new Date(new Date(new Date().setUTCHours(17,0,0,0)).setUTCDate(new Date().getUTCDate() - 1)), lt:new Date(new Date(new Date().setUTCHours(17,0,0,0)).setUTCDate(new Date().getUTCDate()))
      },
    },
    orderBy: [{ ID: "asc" }],
  ...
  return (
    ...
    position: absolute"
                    ...
                    <div className="flex flex-col">
                      ...
                      <select {...register('status')} defaultValue={filter} className={"h-10 "}>
