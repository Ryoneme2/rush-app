...
import CardEditRoleManagement from "components/BackOffice/Cards/CardEditRoleManagement";
import CardEditRegisterRoleManagement from "components/BackOffice/Cards/CardEditRegisterRoleManagement ";
...
export async function getServerSideProps(context) {
  ...
  const response = await prisma.aCCOUNT_PROFILE.findFirst({
    where: { ID: parseInt(context.params.id), IS_ACTIVE: true },
    ...
    <>
      <div className="flex flex-wrap">
        <div className="w-full">
          <CardEditRegisterRoleManagement />
        </div>
