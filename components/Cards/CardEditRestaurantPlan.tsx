...
export default function CardEditRestaurantPlan({ dataMenu, restaurantId, menuC }) {
  const {
    register,
    handleSubmit,
    watch,
  ...
  const onSubmit = async (data) => {
    ...
    const endpoint = `/api/restaurant_plan/upsert`;
          ...
          <div className="rounded-t bg-white mb-0 px-6 py-6">
            <div className="text-center flex justify-between">
              <h6 className="text-blueGray-700 text-xl font-bold">
                {dataMenu == null ? "เพิ่มรูปภาพแผนผังร้าน" : "แก้ไขรูปภาพแผนผังร้าน"}
              </h6>
              <button
