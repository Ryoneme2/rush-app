...
export default function MobileNavbar() {
    ...
    const disableBtnStyle = "flex flex-col justify-center items-center opacity-60 cursor-not-allowed"
        ...
        <>
            <nav className="bottom-0 z-2 fixed w-full flex lg:hidden items-center ">
                <div className="grid grid-cols-3 gap-0 justify-between w-full py-2 bg-white border text-center text-md">
                    ...
                    <button className={session ? btnStyle : disableBtnStyle} disabled={!session ? true : false} onClick={() => {
                        router.push({
                            pathname: '/myBooking/',
                        })
                    }}>
