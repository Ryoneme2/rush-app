...
export default function CardEditMenuCategories(props) {
  const {
    register,
    handleSubmit,
    watch,
  ...
  const onSubmit = async (data) => {
    ...
    const endpoint = `/api/menu_categories/upsert`;
      ...
      >
        <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
          <div className="rounded-t bg-white mb-0 px-6 py-6">
            <div className="text-center flex justify-between">
              <h6 className="text-blueGray-700 text-xl font-bold">
                {props.Data == null ? "เพิ่มหมวดหมู่เมนูอาหาร" : "แก้ไขหมวดหมู่เมนูอาหาร"}
              </h6>
              <button
          ...
          <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
            ...
            <div className="flex flex-wrap">
              <div className="w-full lg:w-6/12 px-4">
                <div className="relative w-full mb-3">
                  ...
                  >
                    ชื่อหมวดหมู่อาหาร <span className="text-red-600">*</span>
                  </label>
                  <input
                    type="hidden"
            ...
            <h6 className="text-blueGray-400 text-sm mt-3 mb-6 font-bold uppercase">
              คำอธิบายเกี่ยวกับหมวดหมู่เมนูอาหาร
            </h6>
            <div className="flex flex-wrap">
